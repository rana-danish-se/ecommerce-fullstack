...
const HomeAndOutdoor = ({ apiData = null }) => {
  // Default static data - will be replaced by API data when available
  const defaultData = {
    title: 'Home and outdoor',
    buttonText: 'Source now',
    bannerImage: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=600&q=80',
    products: [
      {
        id: 1,
        name: 'Soft chairs',
      ...
      },
      {
        ...
        name: 'Kitchen dishes',
        price: 'USD 19',
        image: 'https://images.unsplash.com/photo-1584990347449-39b4c01c7d4f?w=400&q=80'
      },
      {
        id: 4,
        name: 'Smart watches',
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-9 gap-0">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-amber-100/80 to-amber-50/60" />
